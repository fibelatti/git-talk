 ...
 * ==========================================================
 * Copyright (c) 2018 Nicolas CARLO (@nicoespeon) Ù©(^â€¿^)Û¶
 * Copyright (c) 2018 Fabien BERNARD (@fabien0102) âœŒ(âœ°â€¿âœ°)âœŒ
 *
...
(function () {
   ...
   *
   * @param {CanvasRenderingContext2D} context - Canvas 2DÂ context in which to render text.
